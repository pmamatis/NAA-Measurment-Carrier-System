...
outputs:
- {id: CLKOUT_clock.outFreq, value: 180 MHz}
- {id: FRO12M_clock.outFreq, value: 12 MHz}
- {id: FROHF_clock.outFreq, value: 96 MHz}
...
- {id: SYSCON.FXCLKSEL1.sel, value: SYSCON.FROHFDIV}
- {id: SYSCON.FXCLKSEL2.sel, value: SYSCON.FROHFDIV}
...
- {id: SYSCON.FXCLKSEL8.sel, value: SYSCON.FROHFDIV}
...
void BOARD_BootClockPLL180M(void)
{
    ...
    SYSCON->FROHFDIV = ((SYSCON->FROHFDIV & ~SYSCON_FROHFDIV_DIV_MASK) | SYSCON_FROHFDIV_DIV(1U)); /*!< Set FROHF CLKDIV  to value 1 */
    CLOCK_AttachClk(kFRO_HF_to_FLEXCOMM1);                      /*!< Switch FLEXCOMM1 to FRO_HF */
    ...
    CLOCK_AttachClk(kFRO_HF_to_FLEXCOMM8);                      /*!< Switch FLEXCOMM8 to FRO_HF */
    CLOCK_AttachClk(kFRO12M_to_FLEXCOMM9);                  /*!< Switch FLEXCOMM9 to FRO12M */
    CLOCK_AttachClk(kSYSTICK_DIV_CLK_to_SYSTICKCLK);                  /*!< Switch SYSTICKCLK to SYSTICK_DIV_CLK */
